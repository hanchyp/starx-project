  ...
  useEffect(() => {
    ...
    const fetchTokenInfo = async () => {
      try {
        ...
        try {
          const purcRes = await fetch(
            `https://silver-permanent-goldfish-229.mypinata.cloud/ipfs/${purchaseRewardURI}`
          );
          const purcJson = await purcRes.json();
          const holdRes = await fetch(
            `https://silver-permanent-goldfish-229.mypinata.cloud/ipfs/${holdRewardURI}`
          );
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-8 mb-8">
                ...
                <div className="text-center">
                  <div className="text-2xl font-medium text-gray-900">
                    {formatEther(data.pricePerToken)} ETH
                  </div>
                  <div className="text-sm text-gray-500 uppercase tracking-wide">
                    Price per Token
                  </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            <Card className="border-gray-200 shadow-sm">
              ...
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Join the community of supporters and be part of the future of
                  music ownership. Token holders get access to exclusive
                  content, early releases, and special events.
                </p>
              </CardContent>
            </Card>
            ...
            <Dialog
              open={showTransferSection}
              onOpenChange={setShowTransferSection}
            >
              <DialogContent className="max-w-md">
                <DialogHeader>
            ...
            <Card className="border-gray-200 shadow-sm">
              ...
              <CardContent className="">
                <Link href={`/artists/${tokenAddress}/benefit`}>
                  <Button className="w-full">Claim Your Rewards</Button>
                </Link>
              </CardContent>
            </Card>
          </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-medium text-gray-900">
                      {availableSupply !== null
                        ? Number(formatEther(availableSupply)).toLocaleString()
                        : "—"}
                    </span>
                  </div>
              ...
              <CardContent className="pt-6 space-y-6">
                  ...
                  <div className="bg-gray-50 p-3 rounded-lg border border-gray-200 space-y-1">
                    ...
                    <div className="flex justify-end">
                      <span className="text-[11px] text-gray-500 bg-gray-100 px-2 py-0.5 rounded-md">
                        Min. {formatEther(data.minPurchaseForReward)}{" "}
                        {data.symbol}
                      </span>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className="bg-gray-50 p-3 rounded-lg border border-gray-200 space-y-1">
                    ...
                    <div className="flex justify-end">
                      <span className="text-[11px] text-gray-500 bg-gray-100 px-2 py-0.5 rounded-md">
                        {formatEther(data.minHoldAmount)} {data.symbol} for{" "}
                        {minHoldDurationDay} days
                      </span>
                    </div>
